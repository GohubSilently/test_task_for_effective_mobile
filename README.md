...
Сначала прочитал, статью на Хабре, как работает 'django.contrib.auth'. - ВСТАВИТЬ ССЫЛКУ!!!!
После этого наткнулся на видос, который длится около двух часов (спасибо за возможности ускорить видео). - ВСТАВИТЬ ССЫЛККУ!
